...
class AppState with ChangeNotifier {
  ...
  ThemeData appTheme = ThemeData(colorScheme: ColorScheme.fromSeed(seedColor: Colors.yellow));
  ...
  Color setAppColor(Color newColor) {
    appColor = newColor;
    appTheme = ThemeData(colorScheme: ColorScheme.fromSeed(seedColor: appColor));
    notifyListeners();
